...
// --- 5. SEGURIDAD DE VISIBILIDAD (ACTUALIZADO) ---
document.addEventListener("visibilitychange", () => {
    // Solo reinicia si la pestaña se oculta Y NO estamos tomando una foto
    if (document.hidden && !tomandoFoto) {
        ...
        statusTxt.innerHTML = `<i class="bi bi-exclamation-octagon-fill"></i> Seguridad: Pestaña oculta detectada.`;
